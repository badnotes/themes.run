...
description: 'Hugoplate is a free starter template built with Hugo and Tailwind CSS v4.0 that will save you hours of work. '
author: 'zeon-studio'
image: '/blog/hugo/hugoplate/1.png'
tags: ['Blog', 'Dark', 'Search', 'Responsive', 'Comment', 'Tailwind']
images:
  - src: "/blog/hugo/hugoplate/1.png"
    alt: "hugoplate"
  - src: "/blog/hugo/hugoplate/2.png"
    alt: "hugoplate"
  - src: "/blog/hugo/hugoplate/3.png"
    alt: "hugoplate"
  - src: "/blog/hugo/hugoplate/4.png"
    alt: "hugoplate"
  - src: "/blog/hugo/hugoplate/5.png"
    alt: "hugoplate"
...
license: MIT
star: 1214
git: https://github.com/zeon-studio/hugoplate
web: https://zeon.studio/preview?project=hugoplate
...
<h2 align="center"> 
<a target="_blank" href="https://zeon.studio/preview?project=hugoplate" rel="nofollow">👀 Demo</a> | <a  target="_blank" href="https://pagespeed.web.dev/analysis/https-hugoplate-netlify-app/6lyxjw6t4r?form_factor=desktop">Page Speed (95+)🚀</a>
</h2>
