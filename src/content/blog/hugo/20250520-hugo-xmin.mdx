...
description: 'eXtremely Minimal Hugo theme: about 140 lines of code in total, including HTML and CSS (with no dependencies) '
author: 'yihui'
image: '/blog/hugo/hugo-xmin/1.png'
tags: ['Blog', 'Minimal', 'RSS']
images:
  - src: "/blog/hugo/hugo-xmin/1.png"
    alt: "hugo-xmin"
  - src: "/blog/hugo/hugo-xmin/2.png"
    alt: "hugo-xmin"
  - src: "/blog/hugo/hugo-xmin/3.png"
    alt: "hugo-xmin"
  - src: "/blog/hugo/hugo-xmin/4.png"
    alt: "hugo-xmin"
...
license: MIT
star: 827
git: https://github.com/yihui/hugo-xmin
web: https://xmin.yihui.org/
