---
title: 'ink-free'
pubDate: 2024-12-28T00:00:00Z
description: 'Crisp, minimal personal website and blog theme Hugo, designed for a collaborative, open-source, privacy conscious blog. '
author: 'chollinger93'
image: '/blog/hugo/ink-free/1.png'
tags: ['Blog', 'RSS', 'Dark']
images:
  - src: "/blog/hugo/ink-free/1.png"
    alt: "ink-free"
  - src: "/blog/hugo/ink-free/2.png"
    alt: "ink-free"
  - src: "/blog/hugo/ink-free/3.png"
    alt: "ink-free"
  - src: "/blog/hugo/ink-free/4.png"
    alt: "ink-free"
...
price: Free
license: MIT
git: https://github.com/chollinger93/ink-free
web: https://chollinger.com/blog/
...
[Example](https://chollinger.com/blog)
![](https://themes.gohugo.io/themes/ink-free/) 
[![Minimum Hugo Version](https://img.shields.io/static/v1?label=HUGO-version&message=>=0.87.0&color=blue&logo=hugo)](https://github.com/gohugoio/hugo/releases/tag/v0.87.0) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
</div>
