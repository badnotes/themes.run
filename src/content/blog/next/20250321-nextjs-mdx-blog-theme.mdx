...
pubDate: 2023-04-27T00:00:00Z
description: 'Starter template for a personal website blog, built with Next.js, MDX, and Tailwind CSS. '
author: 'alexcarpenter'
image: '/blog/next/nextjs-mdx-blog-theme/1.png'
tags: ['Blog', 'Dark', 'Tailwind']
images:
  - src: "/blog/next/nextjs-mdx-blog-theme/1.png"
    alt: "nextjs-mdx-blog-theme"
  - src: "/blog/next/nextjs-mdx-blog-theme/2.png"
    alt: "nextjs-mdx-blog-theme"
  - src: "/blog/next/nextjs-mdx-blog-theme/3.png"
    alt: "nextjs-mdx-blog-theme"
...
license: --
star: 84
git: https://github.com/alexcarpenter/nextjs-mdx-blog-theme
web: https://nextjs-mdx-blog-theme.vercel.app/
