...
image: '/blog/next/boundless-nextjs-ecommerce-template/1.jpg'
tags: ['SAAS', 'Responsive']
images:
  - src: "/blog/next/boundless-nextjs-ecommerce-template/1.jpg"
    alt: "boundless-nextjs-ecommerce-template"

type: Next
price: Free
license: MIT
star: 136
git: https://github.com/kirill-zhirnov/boundless-nextjs-ecommerce-template
web: https://boundless-commerce.com/
