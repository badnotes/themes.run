...
description: "Open-source admin dashboard template built with Astro, Flowbite, and Tailwind CSS "
author: 'themesberg'
image: '/blog/astro/flowbite-astro-admin-dashboard/1.jpg'
tags: ['Admin', 'Dashboard', 'Tailwind']
images:
  - src: "/blog/astro/flowbite-astro-admin-dashboard/1.jpg"
    alt: "flowbite-astro-admin-dashboard"
...
license: MIT
star: 690
git: https://github.com/themesberg/flowbite-astro-admin-dashboard
web: https://themesberg.github.io/flowbite-astro-admin-dashboard/
