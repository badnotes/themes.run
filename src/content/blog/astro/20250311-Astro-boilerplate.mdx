...
description: '🚀 Astro boilerplate with responsive blog and portfolio template using TypeScript and React styled with Tailwind CSS ⚡️ Made with developer experience first: TypeScript + ESLint + Prettier + Husky + Lint-Staged + Commitlint + VSCode '
author: 'ixartz'
image: '/blog/astro/Astro-boilerplate/1.jpg'
tags: ['Blog', 'Tailwind', 'SEO', 'RSS']
images:
  - src: "/blog/astro/Astro-boilerplate/1.jpg"
    alt: "Astro-boilerplate"
  - src: "/blog/astro/Astro-boilerplate/2.jpg"
    alt: "Astro-boilerplate"
  - src: "/blog/astro/Astro-boilerplate/3.jpg"
    alt: "Astro-boilerplate"
...
license: MIT
star: 826
git: https://github.com/ixartz/Astro-boilerplate
web: https://creativedesignsguru.com/demo/astro-boilerplate/
