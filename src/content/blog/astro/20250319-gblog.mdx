...
description: '🎈gblog, an open-source, simple and beautiful blog built with Astro '
author: 'godruoyi'
image: '/blog/astro/gblog/1.jpg'
tags: ['Blog', 'Dark', 'Tailwind', 'SEO', 'RSS', 'Google']
images:
  - src: "/blog/astro/gblog/1.jpg"
    alt: "gblog"
  - src: "/blog/astro/gblog/2.png"
    alt: "gblog"
  - src: "/blog/astro/gblog/3.png"
    alt: "gblog"
  - src: "/blog/astro/gblog/4.jpg"
    alt: "gblog"
  - src: "/blog/astro/gblog/5.png"
    alt: "gblog"
...
license: MIT
star: 433
git: https://github.com/godruoyi/gblog
web: https://godruoyi.com/
