---
title: 'Astro-air'
pubDate: 2025-02-04T00:00:00Z
description: 'minimalism, personal blog theme for Astro '
author: 'sun0225SUN'
image: '/blog/astro/astro-air/1.png'
tags: ['Blog', 'Dark', 'i18n', 'Comment', 'RSS']
images:
  - src: "/blog/astro/astro-air/1.png"
    alt: ""
  - src: "/blog/astro/astro-air/2.png"
    alt: ""
  - src: "/blog/astro/astro-air/3.png"
    alt: ""
  - src: "/blog/astro/astro-air/4.png"
    alt: ""
type: Astro
price: Free
license: MIT
git: https://github.com/sun0225SUN/astro-air
web: https://astro-air.guoqi.dev/en/
