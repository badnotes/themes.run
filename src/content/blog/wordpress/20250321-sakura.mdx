...
description: 'A Wonderful WordPress Theme: 樱花庄的白猫博客主题 '
author: 'Licoy'
image: '/blog/wordpress/sakura/screenshot.jpg'
tags: ['Blog', 'Dark', 'Search', 'RSS', 'Comment', 'Powerful']
images:
  - src: "/blog/wordpress/sakura/screenshot.jpg"
    alt: "sakura"
  - src: "/blog/wordpress/sakura/1.jpg"
    alt: "sakura"
  - src: "/blog/wordpress/sakura/2.jpg"
    alt: "sakura"
  - src: "/blog/wordpress/sakura/3.jpg"
    alt: "sakura"
...
license: GPL2.0
star: 3652
git: https://github.com/mashirozx/sakura
web: https://2heng.xin/theme-sakura/
...
![Sakura](/blog/wordpress/sakura/screenshot.jpg)
